...
export default class SwanSDK {
  appId = '';
  deviceId = '';
  webSDKUrl = 'https://swan-web-sdk.azureedge.net/api';
  ...
  async fetchNotificationFromAPI() {
    try {
      const response = await fetch(`${this.webSDKUrl}/post-in-app-notification-to-sdk?appId=${this.appId}&mobile=919019467907`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
