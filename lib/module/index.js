...
export default class SwanSDK {
  ...
  deviceId = '';
  // QA URLs
  // private webSDKUrl: string = 'https://swan-web-sdk.azurewebsites.net/api';
  // private ecomSDKUrl: string = 'https://e-commerce.azurefd.net/api';

  // Production URLs
  webSDKUrl = 'https://click.swan.cx/api';
  ecomSDKUrl = 'https://connect.swan.cx/events/sdk';
