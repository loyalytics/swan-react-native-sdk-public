...
export default class SwanSDK {
  ...
  async getNotificationComponent() {
    ...
    if (!lastNotificationFetchFromApi || (await this.isGreaterThanTimePeriod(lastNotificationFetchFromApi, 2))) {
    ...
    if (!lastNotificationFetchFromDB || (await this.isGreaterThanTimePeriod(lastNotificationFetchFromDB, 2))) {
